...
export const UploadCV = ({ onUploadSuccess }) => {
  ...
  const handleFileChange = async (e) => {
    ...
    if (onUploadSuccess) onUploadSuccess({ cvId: 'temp', name: 'Processing...' });
  };
        ...
        >
          ...
          {uploading ? (
            ...
            <div className={`flex items-center justify-between gap-2 p-2 rounded-lg ${
              darkMode ? 'bg-gray-700/80' : 'bg-white shadow-sm'
            }`}>
              ...
              <button 
                ...
                className={`p-1 rounded-full transition-colors ${
                  darkMode ? 'hover:bg-gray-600 text-gray-300 hover:text-red-400' : 'hover:bg-gray-100 text-gray-500 hover:text-red-500'
                }`}
              >
            ...
            <div className="py-3">
              <div className={`w-12 h-12 mx-auto rounded-xl flex items-center justify-center transition-all group-hover:scale-105 ${
