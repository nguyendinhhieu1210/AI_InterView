...
export default function SettingsPage() {
  ...
  const [browserNotifications, setBrowserNotifications] = useState(
    () => localStorage.getItem('browserNotifications') === 'true'
  );
    ...
    <div className="min-h-screen transition-colors py-8 px-4 sm:px-6 lg:px-8 bg-bg text-text">
      <div className="max-w-4xl mx-auto">
        ...
        <BaseButton
          ...
          className="group mb-8 gap-2 text-muted hover:text-primary"
        >
          Back to Dashboard
        </BaseButton>
        ...
        <div className="space-y-6">
          {/* Appearance Card */}
          <BaseCard hover className="p-6 transition-all">
            ...
            <div className="flex items-center justify-between pt-2 border-t border-border">
              ...
              >
                <span
                  className={`${theme === 'dark' ? 'translate-x-6' : 'translate-x-1'} inline-block h-5 w-5 transform rounded-full bg-white shadow-md transition-transform duration-300`}
                />
                <span className="absolute left-1.5 text-[10px] text-white/70">
                  {theme !== 'dark' && '☀️'}
                </span>
                <span className="absolute right-1.5 text-[10px] text-white/70">
                  {theme === 'dark' && '🌙'}
                </span>
              </button>
            </div>
          ...
          <BaseCard hover className="p-6 transition-all">
            ...
            <div className="space-y-5 pt-2 border-t border-border">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted mt-0.5">
                      Receive interview results and tips
                    </p>
                  </div>
                </div>
              ...
              <BaseButton
                ...
                className="mt-2 px-5 py-2.5 shadow-md hover:shadow-lg"
              >
                Save Preferences
              </BaseButton>
            </div>
          ...
          <BaseCard hover className="p-6 transition-all">
            ...
            >
              ...
              <BaseButton
                ...
                variant="primary"
                loading={changing}
                leftIcon={!changing && <KeyRound className="w-5 h-5" />}
                disabled={changing}
                className="px-6 py-3 bg-gradient-to-r from-warning to-orange-500 text-white border-0 shadow-md hover:brightness-105"
              >
                Change Password
              </BaseButton>
            </form>
