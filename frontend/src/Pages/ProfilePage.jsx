              ...
              <div className="relative pt-16 pb-6 px-6 text-center">
                  ...
                  <div className="relative">
                    {avatarPreview ? (
                      <img
                        src={avatarPreview}
                        alt="Avatar"
                        className="w-32 h-32 rounded-full border-4 border-card object-cover shadow-soft transition-all duration-300 group-hover:scale-105 group-hover:shadow-md"
                      />
                    ) : (
                ...
                <div className="mt-5 space-y-2.5 text-left">
                  <div className="flex items-center gap-3 text-muted p-2 rounded-xl hover:bg-muted/10 transition-all group">
                    ...
                    <span className="text-sm break-all text-text">
                      {user.email}
                    </span>
                  </div>
                  <div className="flex items-center gap-3 text-muted p-2 rounded-xl hover:bg-muted/10 transition-all group">
              ...
              <div className="p-5 divide-y divide-border">
                {historyLoading ? (
                  ...
                  recentActivities.map((activity) => (
                    <div
                      key={activity.id}
                      className="flex items-center gap-4 py-3 first:pt-0 last:pb-0 group hover:bg-muted/5 rounded-lg px-2 transition-all"
                    >
                      ...
                      {activity.scoreDisplay && (
                        <div
                          className={`flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-semibold ${getScoreColorClass(activity)}`}
                        >
                          {activity.scoreDisplay}
                        </div>
                      )}
