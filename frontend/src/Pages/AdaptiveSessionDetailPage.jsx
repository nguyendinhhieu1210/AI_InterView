...
export default function AdaptiveSessionDetailPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-bg">
        <div className="text-center">
          ...
          <p className="text-muted font-medium animate-pulse leading-relaxed">Loading interview report...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4 bg-bg">
        <div className="bg-card rounded-2xl p-8 text-center shadow-soft border border-border max-w-md w-full">
          ...
          <p className="text-text mb-6 leading-relaxed">{error || 'Session not found'}</p>
          <button
  ...
  // Màu chính cho Adaptive: Violet (giống AdaptiveHistoryPage)
  const adaptiveColor = {
    primary: 'violet',
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-wrap justify-between items-center gap-4 mb-8">
          ...
          <div className="bg-card/60 backdrop-blur-sm rounded-full px-5 py-2 shadow-soft border border-border">
            <span className="text-xs font-medium text-muted">Adaptive Interview</span>
          </div>
        </div>
        ...
        <div className="mb-10 text-center sm:text-left">
          ...
          <div className="flex flex-wrap justify-center sm:justify-start gap-3 mt-3 text-sm text-muted">
            ...
            <span className={`px-2.5 py-0.5 rounded-full text-xs font-semibold ${getDifficultyBadge(session.difficulty)}`}>
              {session.difficulty}
            </span>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-5 mb-12">
          <div className="group bg-card rounded-2xl p-5 text-center shadow-soft hover:shadow-lg transition-all duration-300 border border-border hover:scale-105">
            ...
            <div className={`text-3xl font-bold ${getScoreColor(finalScore10)} leading-none`}>
              {finalScore10.toFixed(1)}<span className="text-sm text-muted">/10</span>
            </div>
            <div className="text-xs text-muted mt-2 font-medium">Final Score</div>
          </div>
          ...
          <div className="group bg-card rounded-2xl p-5 text-center shadow-soft hover:shadow-lg transition-all duration-300 border border-border hover:scale-105">
            ...
            <div className="text-xl font-bold text-text leading-tight">{summary.overallEvaluation || 'N/A'}</div>
            <div className="text-xs text-muted mt-2 font-medium">Evaluation</div>
          </div>
          ...
          <div className="group bg-card rounded-2xl p-5 text-center shadow-soft hover:shadow-lg transition-all duration-300 border border-border hover:scale-105">
            ...
            <div className="text-sm font-bold text-text leading-tight">{summary.hireRecommendation || 'N/A'}</div>
            <div className="text-xs text-muted mt-2 font-medium">Recommendation</div>
          </div>
          ...
          <div className="group bg-card rounded-2xl p-5 text-center shadow-soft hover:shadow-lg transition-all duration-300 border border-border hover:scale-105">
            ...
            <div className="text-xl font-bold text-text leading-tight">{summary.grade || 'N/A'}</div>
          ...
          <div className="bg-gradient-to-r from-violet-50/80 to-purple-50/80 dark:from-violet-950/20 dark:to-purple-950/20 rounded-2xl p-6 shadow-soft mb-8 border border-primary/20">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h3 className="font-semibold text-text text-lg mb-2 leading-tight">AI Interviewer's Summary</h3>
                <p className="text-muted leading-relaxed text-sm">{summary.summary}</p>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {summary.strengths.map((s, i) => (
                            <span key={i} className="px-2.5 py-1 bg-success/10 text-success text-xs rounded-full leading-relaxed">
                              + {s}
                            </span>
                          ))}
                        </div>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {summary.weaknesses.map((w, i) => (
                            <span key={i} className="px-2.5 py-1 bg-error/10 text-error text-xs rounded-full leading-relaxed">
                              - {w}
                            </span>
                          ))}
                        </div>
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-5">
            ...
            <h2 className="text-xl font-bold text-text leading-tight">Interview Transcript & Detailed Scoring</h2>
          </div>
              ...
              >
                ...
                >
                  <div className="flex gap-4">
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold shadow-sm ${getScoreBg(qa.answerScore)} leading-tight`}>
                  ...
                  <div className="p-5 border-t border-border space-y-5 bg-muted/5 animate-slideDown">
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-text leading-relaxed text-sm">{qa.question}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-text whitespace-pre-wrap leading-relaxed text-sm">{qa.answer}</p>
                      </div>
                    </div>
                    ...
                    {qa.answerScore !== null && (
                      <div className="flex flex-wrap items-center gap-3 pt-2">
                        <div className={`px-3 py-1 rounded-full text-sm font-bold ${getScoreBg(qa.answerScore)} leading-relaxed`}>
                          Score: {qa.answerScore.toFixed(1)}/10
                        </div>
                        {qa.verdict && (
                          <div className="text-sm text-muted leading-relaxed">
                            Verdict: <span className="font-semibold text-text">{qa.verdict}</span>
                          </div>
                        )}
                        {qa.answerScore >= 7 ? (
                    ...
                    {qa.idealAnswer && (
                      <div className="flex gap-3 pt-2 border-t border-border">
                        ...
                        <div className="flex-1">
                          <div className="text-xs font-semibold text-success mb-1 leading-relaxed">✨ Ideal Answer (What the interviewer expected)</div>
                          <p className="text-muted text-sm leading-relaxed">{qa.idealAnswer}</p>
                        </div>
                      </div>
                    )}
                    ...
                    {qa.feedback && (
                      <div className="flex gap-3">
                        ...
                        <div className="flex-1">
                          <div className="text-xs font-semibold text-warning mb-1 leading-relaxed">📝 AI Feedback</div>
                          <p className="text-muted text-sm leading-relaxed">{qa.feedback}</p>
                        </div>
                      </div>
                    )}
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {qa.strengths.map((s, i) => (
                            <span key={i} className="px-2 py-0.5 bg-success/10 text-success text-xs rounded-full leading-relaxed">
                              {s}
                            </span>
                          ))}
                        </div>
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {qa.weaknesses.map((w, i) => (
                            <span key={i} className="px-2 py-0.5 bg-error/10 text-error text-xs rounded-full leading-relaxed">
                              {w}
                            </span>
                          ))}
                        </div>
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {qa.missingConcepts.map((m, i) => (
                            <span key={i} className="px-2 py-0.5 bg-warning/10 text-warning text-xs rounded-full leading-relaxed">
                              {m}
                            </span>
                          ))}
                        </div>
        ...
        {summary.learningRoadmap && summary.learningRoadmap.length > 0 && (
          <div className="bg-gradient-to-r from-violet-50/80 to-purple-50/80 dark:from-violet-950/20 dark:to-purple-950/20 rounded-2xl p-6 shadow-soft border border-primary/20">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h3 className="font-semibold text-text text-lg mb-3 leading-tight">Recommended Learning Roadmap</h3>
                <div className="flex flex-wrap gap-2">
                  {summary.learningRoadmap.map((item, i) => (
                    <span key={i} className="px-3 py-1.5 bg-card text-primary text-sm rounded-xl shadow-sm border border-border leading-relaxed">
                      📘 {item}
                    </span>
                  ))}
                </div>
