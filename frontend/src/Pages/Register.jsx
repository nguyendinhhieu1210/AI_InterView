...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => {
        navigate("/verify-otp", {
          state: { email: response.data.email, purpose: "email-verification" },
        });
      }, 2000);
    } catch (error) {
  ...
  const interviewTypes = [
    {
      icon: FileText,
      label: "CV Analysis Interview",
      description: "AI analyzes your CV and asks relevant questions",
      color: "text-blue-500",
    ...
    },
    {
      ...
      description: "Traditional Q&A format with AI scoring",
    ...
    },
    {
      ...
      description: "Live coding challenges with AI evaluation",
        ...
        <div className="hidden lg:block flex-1">
          ...
          >
            <div className="relative">
              ...
              >
                Join thousands of candidates who've improved their interview
                skills with our AI-driven platform.
              </p>
                ...
                <div className="space-y-3">
                  {interviewTypes.map((type, idx) => {
                    ...
                    return (
                      <div
                        key={idx}
                        className={`flex items-start gap-3 p-3 rounded-xl transition-all ${type.bg} hover:scale-[1.02]`}
                      >
              ...
              <div className="flex flex-wrap gap-3 mb-8">
                {features.map((feature, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm"
                    >
              ...
              <div>
                ...
                {form.password && (
                  <div className="mt-2 space-y-1 animate-slideDown">
                    ...
                    >
                      <CheckCircle className="w-3 h-3" /> Min. 6 chars,
