    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4 bg-bg">
        <div className="bg-card rounded-2xl p-8 text-center max-w-md shadow-soft border border-border">
          ...
          <button onClick={fetchAdaptiveHistory} className="px-5 py-2.5 bg-primary text-white rounded-xl flex items-center gap-2 mx-auto hover:brightness-105 transition shadow-md">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-10">
        ...
        <div className="flex flex-wrap justify-between items-center gap-3 mb-6">
          ...
          <div className="bg-card/80 backdrop-blur-sm rounded-full px-5 py-2 shadow-soft border border-border">
            ...
            <span className="font-semibold text-text">{sessions.length} Adaptive Sessions</span>
          </div>
        </div>
        ...
        {sessions.length === 0 ? (
          <div className="bg-card backdrop-blur rounded-2xl p-12 text-center shadow-soft border border-border">
            ...
            <h3 className="text-xl font-semibold text-text mb-2">No adaptive interviews yet</h3>
            <p className="text-muted mb-4">Start an adaptive interview and test your knowledge in real-time.</p>
            <button onClick={() => navigate('/adaptive-interview')} className="px-6 py-2.5 bg-primary text-white rounded-xl hover:brightness-105 transition shadow-md">
                      ...
                      <div className="flex justify-between items-end mt-2 pt-2 border-t border-border">
                        <div>
                          ...
                          <div className={`text-2xl font-bold ${getScoreColor(parseFloat(score10))}`}>
                            {score10}<span className="text-sm font-normal text-muted">/10</span>
                          </div>
                        </div>
                        <button
