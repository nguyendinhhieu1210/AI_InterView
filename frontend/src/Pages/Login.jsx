...
import {
    ...
    FileText, Code, Cpu, Target, Award, TrendingUp
} from 'lucide-react';
...
export default function Login() {
    ...
    const interviewTypes = [
        { icon: FileText, label: 'CV Analysis', description: 'AI analyzes your CV', color: 'text-blue-500', bg: 'bg-blue-50 dark:bg-blue-950/30' },
        { icon: Brain, label: 'Adaptive', description: 'Real-time skill adaptation', color: 'text-indigo-500', bg: 'bg-indigo-50 dark:bg-indigo-950/30' },
        { icon: Users, label: 'Standard', description: 'Traditional Q&A format', color: 'text-purple-500', bg: 'bg-purple-50 dark:bg-purple-950/30' },
        { icon: Code, label: 'Coding', description: 'Live coding challenges', color: 'text-emerald-500', bg: 'bg-emerald-50 dark:bg-emerald-950/30' },
    ];
                        ...
                        <div className="relative">
                            ...
                            <div className="mb-8">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    {interviewTypes.map((type, idx) => {
                                        ...
                                        return (
                                            <div key={idx} className={`flex items-center gap-2 p-2 rounded-lg transition-all ${type.bg}`}>
                            ...
                            <div className="flex flex-wrap gap-2 mb-8">
                                {features.map((feature, idx) => {
                                    ...
                                    return (
                                        <div key={idx} className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm">
