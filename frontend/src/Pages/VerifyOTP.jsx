...
import { Key, CheckCircle, AlertCircle, ArrowLeft, Shield } from "lucide-react";
...
export default function VerifyOTP() {
  ...
  const email =
    location.state?.email || localStorage.getItem("tempEmail") || "";
          ...
          {!success ? (
            <form onSubmit={handleSubmit} className="p-8 space-y-5">
              ...
              <button
                ...
                onClick={() =>
                  navigate(
                    purpose === "email-verification" ? "/register" : "/login",
                  )
                }
