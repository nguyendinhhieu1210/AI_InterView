# 📋 Product Backlog Ban Đầu – AI InterView

> **Phiên bản:** 1.0  
> **Ngày tạo:** 2026-05-29  
> **Trạng thái:** Sprint 0 – Initial Backlog  
...
| **Admin** | Quản trị hệ thống (dự kiến mở rộng) |
...
| EP2-3 | AI sinh 5 câu MCQ + 5 câu tự luận theo chủ đề | L | ✅ Done |
...
| EP4-5 | Kết thúc session → Tổng kết điểm | M | ✅ Done |
...
| ID | Feature / User Story | Ước Tính | Trạng Thái |
|---|---|---|---|
| EP5-1 | AI sinh bài toán coding (theo ngôn ngữ & độ khó) | L | ✅ Done |
| EP5-2 | Monaco Editor tích hợp trong trình duyệt | L | ✅ Done |
| EP5-3 | Hỗ trợ nhiều ngôn ngữ lập trình | M | ✅ Done |
| EP5-4 | AI chấm điểm code và feedback | L | ✅ Done |
| EP5-5 | Lưu LiveCodingSession vào database | M | ✅ Done |
...
| EP6-4 | Trang tổng hợp toàn bộ lịch sử (InterviewHistoryPage) | M | ✅ Done |
| EP6-5 | Biểu đồ xu hướng điểm (PerformanceTrendChart) | L | ✅ Done |
| EP6-6 | Heatmap hoạt động hàng ngày (ActivityCalendar) | M | ✅ Done |
| EP6-7 | Phân tích điểm yếu theo chủ đề (WeaknessAnalysis) | L | ✅ Done |
...
| EP7-4 | Cài đặt thông báo | S | ✅ Done |
...
| **Should Have** | EP4, EP5 | Quan trọng – nên có |
| **Nice to Have** | EP7 | Cải thiện UX |
| **Won't Have (v1)** | Admin Dashboard | Dự kiến v2 |
