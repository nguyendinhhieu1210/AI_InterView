...
MongoDB database có **9 collections** chính:
...
| --------------------- | -------- | --------------------------------------- | ---------------------------- |
| `_id`                 | ObjectId | auto                                    | Primary key                  |
| `question`            | String   | required, text index                    | Nội dung câu hỏi             |
| `options`             | Object   | required                                | 4 lựa chọn A/B/C/D           |
| `correctAnswer`       | String   | enum: ['A','B','C','D']                 | Đáp án đúng                  |
| `explanation`         | String   | required                                | Giải thích đáp án            |
| `programmingLanguage` | String   | required, indexed                       | Ngôn ngữ lập trình liên quan |
| `difficulty`          | String   | enum: ['Easy','Medium','Hard','Expert'] | Độ khó                       |
| `tags`                | [String] | -                                       | Tag để lọc câu hỏi           |
| `isFeatured`          | Boolean  | default: false                          | Câu hỏi nổi bật              |
| `isActive`            | Boolean  | default: true                           | Có được dùng không           |
| `createdBy`           | ObjectId | ref: User, required                     | Admin tạo câu hỏi            |
| `stats`               | Object   | -                                       | Thống kê lượt thử, đúng/sai  |

---

### 📌 Collection: `examsets`

**File:** `backend/models/ExamSet.js`

| Field                 | Type       | Constraints         | Mô Tả                             |
| --------------------- | ---------- | ------------------- | --------------------------------- |
| `_id`                 | ObjectId   | auto                | Primary key                       |
| `name`                | String     | required            | Tên bộ đề                         |
| `programmingLanguage` | String     | required            | Ngôn ngữ lập trình của bộ đề      |
| `description`         | String     | default: ''         | Mô tả bộ đề                       |
| `questions`           | [ObjectId] | ref: Question       | Danh sách câu hỏi trong bộ đề     |
| `difficultyStats`     | Object     | -                   | Số lượng câu hỏi theo độ khó      |
| `totalQuestions`      | Number     | default: 0          | Tổng số câu hỏi                   |
| `isActive`            | Boolean    | default: true       | Bộ đề có hiệu lực không           |
| `createdBy`           | ObjectId   | ref: User, required | Admin tạo bộ đề                   |
| `metadata`            | Object     | -                   | views/timesPracticed/averageScore |
